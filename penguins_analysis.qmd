...
ggplot(data = penguins_data_from_csv, aes(x = culmen_depth_mm, fill = species)) +
  ...
  labs(title = "Palmer Penguins, Distribution of Culmen Depth",
       subtitle = "Three Penguin Species Observed on Three Islands in the Palmer Archipelago, Antarctica",
       x = "Culmen Depth (mm)",
       y = "Number of Penguins")
```
...
ggplot(data = penguins_data_from_csv, aes(x = culmen_depth_mm, y = body_mass_g, color = species)) +
  ...
  labs(title = "Palmer Penguins, Distribution of Culmen Depth & Body Mass",
       subtitle = "Three Penguin Species Observed on Three Islands in the Palmer Archipelago, Antarctica",
       x = "Culmen Depth (mm)",
       y = "Body Mass (g)")
...
```{r}
penguins_body_mass_boxplot <- ggplot(data = penguins_data_from_csv, aes(x = species, y = body_mass_g, fill = species)) +
  geom_boxplot() +
  theme_minimal() +
  scale_fill_viridis_d() +
  coord_flip() +
...
ggplotly(penguins_body_mass_boxplot)
```

1.  How many penguins live on Torgersen Island? \*52 penguins
