...
-   How do you read a boxplot, and what are the different landmarks?
    -   The thick line in the middle is median (Q2), the data is split into two halves. Each of the two boxes is 25% of the data, The outer lines of the two boxes are Q1 (the lower end) and Q3 (the higher end). The whiskers are the lower 25% of the data and higher 25% of the data, the dots outside of the boxplot are the outliers in the data.
